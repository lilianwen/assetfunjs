...
export const subject_publish_operation_fee_parameters = new Serializer( 
    "subject_publish_operation_fee_parameters", {
    basic_fee: uint64,
    price_per_hour: uint64
}
);

export const subject_vote_operation_fee_parameters = new Serializer( 
    "subject_vote_operation_fee_parameters",
    {fee: uint64}
);

export const subject_event_operation_fee_parameters = new Serializer( 
    "subject_event_operation_fee_parameters",
    {fee: uint64}
);

export const coin_feed_price_operation_fee_parameters = new Serializer( 
    "coin_feed_price_operation_fee_parameters",
    {fee: uint64}
);
...
export const subject_delay_settle = new Serializer( 
    "subject_delay_settle", {
    fixed: time_point_sec,
    delay: uint64
}
);

export const subject_vote_amount_range = new Serializer( 
    "subject_vote_amount_range", {
    min: asset,
    max: asset
}
);

export const subject_prediction_duration_limit = new Serializer( 
    "subject_prediction_duration_limit", {
    less: uint64,
    more: uint64
}
);

export const subject_create_fee = new Serializer( 
    "subject_create_fee", {
    min_amount: uint64,
    fee_per_hour: uint32,
    asset_id: string
...
export const subject_creator_shares = new Serializer( 
    "subject_creator_shares", {
    trade_fee_percent: uint64,
    win_fund_percent: uint64
}
);

export const subject_change_profie = new Serializer( 
    "subject_change_profie", {
...
export const subject_template = new Serializer( 
    "subject_template", {
    event: string,
    unit: price_unit,
...
export const subject_content = new Serializer( 
    "subject_content", {
    description: string,
...
export const subject_options = new Serializer( 
    "subject_options", {
...
export const extend_options = new Serializer( 
    "extend_options",
    {opt: uint32}
);

export const subject_publish = new Serializer( 
    "subject_publish", {
    fee: asset,
    creator: protocol_id_type("account"),
    subject_name: string,
...
export const subject_vote_template = new Serializer( 
    "subject_vote_template", {
    quantity: asset,
    creator_vote: string,
    my_vote: string,
    unit: price_unit
...
export const subject_vote_result = new Serializer( 
    "subject_vote_result", {
    capital: asset,
    reward: asset,
    judge: uint32
...
export const subject_vote = new Serializer( 
    "subject_vote", {
    fee: asset,
...
export const subject_event = new Serializer( 
    "subject_event", {
    fee: asset,
...
export const coin_feed_price = new Serializer( 
    "coin_feed_price", {
    fee: asset,
    publisher: protocol_id_type("account"),
