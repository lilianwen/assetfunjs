...
import {GetSubjectById, GetSubjectsByName, GetSubjectsOrderById, 
    ...
    MyGetSubjectsOrderByVoteEndTime} from "./chain/src/SubjectQuery"
//[end]
...
export {ChainStore, TransactionBuilder, FetchChainObjects, ChainTypes, EmitterInstance,
    ...
    GetSubjectsByStatus, GetSubjectsByCreator, GetSubjectsByCreateTime, 
    GetSubjectsByVoteEndTime, GetSubjectVotesByVoter, GetSubjectVotesBySubjectId, 
    GetSubjectEventsBySubjectId, GetSubjectEventsByOperator,FrontPageGetSubjectsOrderByVoteEndTime,MarketGetSubjectsOrderByVoteEndTime,
    MyGetSubjectsOrderByVoteEndTime }
