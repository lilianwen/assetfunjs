...
describe("ECC", function() {
    ...
    describe("Crypto", function() {
        ...
        it("generate private key from seed", function() {
            ...
            assert.equal(private_key.toPublicKey().toString(), "FID8m5UgaFAAYQRuaNejYdS8FVLVp9Ss3K1qAVk5de6F8s3HnVbvA", "private key does not match");
        })
    ...
    describe("Derivation", ()=> {
        ...
        let to_public = PublicKey.fromStringOrThrow("FID7vbxtK1WaZqXsiCHPcjVFBewVj8HFRd5Z5XZDpN6Pvb2dZcMqK")
        ...
        it("child from public", function() {
            assert.equal(
                ...
                "FID6XA72XARQCain961PCJnXiKYdEMrndNGago2PV5bcUiVyzJ6iL",
