...
var Address = function () {
    ...
    Address.fromString = function fromString(string) {
        var address_prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _fidchainjsWs.ChainConfig.address_prefix;
    ...
    Address.prototype.toString = function toString() {
        var address_prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _fidchainjsWs.ChainConfig.address_prefix;
