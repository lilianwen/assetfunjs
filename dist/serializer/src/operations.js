...
var subject_vote_result = exports.subject_vote_result = new Serializer("subject_vote_result", {
    capital: asset,
    reward: asset,
    judge: uint32
});
